  ...
  <div class="album py-5 bg-light">
    <div class="container">
      <div class="card mb-3">
        ...
        <UserProfileCard :initial_profile="profile" />
      </div>
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="card">
            ...
            <UserFollowingsCard :initial_profile="profile" />
          </div>
          <br />
          <!-- UserFollowersCard，user 的追隨者資料區 -->
          <UserFollowersCard :initial_profile="profile" />
        </div>
        <div class="col-md-8">
          <!-- UserCommentsCard，user 評論過的資料區 -->
          <UserCommentsCard :initial_profile="profile" />
          <br />
          <div class="card">
...
const dummyData = {
  profile: {
    ...
    isAdmin: true,
    image: "https://i.imgur.com/Gs5Ws47.jpg",
